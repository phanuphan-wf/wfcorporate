          ...
          >
            ...
            <View style={{ alignItems: "center" }}>
              <View  style={{flexDirection: "column", justifyContent: "center",alignItems: "center",}}>
                <Text style={{textAlign: "center", fontSize: 10,fontFamily: "Sarabun", marginVertical: 2,}}>
                  {event ? event.name : "-"}
                </Text>
            ...
            {Object.entries(groupedBySales).map(([sales, rows], idx) => {
              ...
              return (
                <View  key={idx}  style={{ marginBottom: 8 }}>
                  ...
                  <View style={[styles.tableRow, styles.tableHeader]}>
                    ...
                    <Text style={[styles.tableCell, { width: 120, textAlign: "center" }]}>โทรศัพท์</Text>
                    <Text style={[styles.tableCellLast, { flex: 1,width: 80, textAlign: "center" }]}>Zone</Text>
                  </View>
                  ...
                  {rows.map((r, i) => (
                    <View key={i} style={styles.tableRow}>
                      ...
                      <View style={[styles.tableCell, { width: 120, textAlign: "left" }]}>
                        {(r.tel ? r.tel : "-")
                          .match(/.{1,30}/g)  // ตัดข้อความทุก 25 ตัวอักษร
                          .map((line, i) => (
                            <Text key={i}>{line}</Text>
                          ))}
                      </View>

                      <Text style={[styles.tableCell, { flex: 1 ,width: 80 ,textAlign: "center"}]}>{r.zone ?? "-"} </Text>
