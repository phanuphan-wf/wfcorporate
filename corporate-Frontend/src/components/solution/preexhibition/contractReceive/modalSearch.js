...
export default function ModalSeach(props) {
  ...
  const nameClick = (id, cname) => {
    setContractDetail({ ...contractDetail, CustomerID: id });
    props.fill(cname);
  };
  ...
  useEffect(() => {
    if (search.Name == "") {
      setContractDetail({ ...contractDetail, CustomerID: 0 });
    }
  }, [search]);
        ...
        <div className="relative w-full max-w-3xl md:max-w-xl lg:max-w-3xl max-h-full top-[100px] left-1/2 md:left-[calc(50%+120px)] -translate-x-1/2">
          ...
          <div className="relative bg-white rounded-lg shadow">
            ...
            <div className="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b justify-between">
              ...
              <div className="text-red-600 cursor-pointer hover:text-red-500 underline-offset-2 decoration-red-500 hover:underline">
                <a href="/solution/datawarehouse/addnewcustomer">
                  Add Customer
                </a>
              </div>
            </div>
