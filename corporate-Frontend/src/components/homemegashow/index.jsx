    ...
    <section className="HomeMegaShow w-full flex flex-col items-center justify-center bg-[#100249]">
      ...
      <div className="w-full flex flex-col items-center justify-center px-8 md:px-8 gap-6">
        ...
        <div className="w-full max-w-[1040px] flex justify-center">
          <img
            src={
              "https://worldfair.blob.core.windows.net/hms2026landing/atmosphere.png"
            }
        ...
        <div className="w-full max-w-[1040px] bg-[#1c0b66] rounded-b-2xl p-4 md:p-6 flex flex-col gap-6 shadow-xl -mt-5">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="overflow-hidden rounded-lg aspect-square md:aspect-auto">
              <img
                src={
                  "https://worldfair.blob.core.windows.net/hms2026landing/fur_img1.jpg"
                }
                alt="furniture 1"
            ...
            <div className="overflow-hidden rounded-lg aspect-square md:aspect-auto">
              <img
                src={
                  "https://worldfair.blob.core.windows.net/hms2026landing/fur_img2.jpg"
                }
                alt="furniture 2"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
              />
            ...
            <div className="overflow-hidden rounded-lg aspect-square md:aspect-auto">
              <img
                src={
                  "https://worldfair.blob.core.windows.net/hms2026landing/fur_img3.jpg"
                }
                alt="furniture 3"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
              />
            ...
            <div className="overflow-hidden rounded-lg aspect-square md:aspect-auto">
              <img
                src={
                  "https://worldfair.blob.core.windows.net/hms2026landing/fur_img4.jpg"
                }
                alt="furniture 4"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
              />
            ...
            <div className="overflow-hidden rounded-lg aspect-square md:aspect-auto">
              <img
                src={
                  "https://worldfair.blob.core.windows.net/hms2026landing/fur_img5.jpg"
                }
                alt="furniture 5"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
              />
            ...
            <div className="overflow-hidden rounded-lg aspect-square md:aspect-auto">
              <img
                src={
                  "https://worldfair.blob.core.windows.net/hms2026landing/fur_img6.jpg"
                }
                alt="furniture 6"
                className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
              />
        ...
        <div className="w-full max-w-[1040px] flex justify-center -mt-3">
          <img
            src={
              "https://worldfair.blob.core.windows.net/hms2026landing/impressions.png"
            }
            alt="atmosphere_event"
            className="w-full h-auto object-contain block"
          />
        ...
        <div className="mx-auto w-full h-auto max-w-[1040px]">
          <img
            src={
              "https://worldfair.blob.core.windows.net/hms2026landing/home.png"
            }
            alt="hero"
        ...
        <div
          ...
          <img
            src={
              "https://worldfair.blob.core.windows.net/hms2026landing/book.png"
            }
            alt="book"
            className="w-full h-auto object-contain"
          />
        ...
        <div className="mx-auto w-full h-auto max-w-[1040px]">
          <img
            src={
              "https://worldfair.blob.core.windows.net/hms2026landing/highlights.png"
            }
            alt="highlights"
            className="w-full h-auto object-contain"
          />
        ...
        <div className="mx-auto w-full h-auto max-w-[1040px]">
          <img
            src={
              "https://worldfair.blob.core.windows.net/hms2026landing/why.png"
            }
            alt="why"
            className="w-full h-auto object-contain"
          />
        ...
        <div className="mx-auto w-full h-auto max-w-[1040px]">
          <img
            src={
              "https://worldfair.blob.core.windows.net/hms2026landing/who.png"
            }
            alt="who"
            className="w-full h-auto object-contain"
          />
        ...
        <div className="w-full flex flex-col items-center">
          ...
          <div
            ...
            <img
              src={
                "https://worldfair.blob.core.windows.net/hms2026landing/interested.png"
              }
              alt="interested"
              className="w-full h-auto object-contain block"
            />
          ...
          <div className="w-full max-w-[1040px] bg-[#1c0b66] rounded-b-2xl shadow-xl -mt-2 md:-mt-5 overflow-hidden">
            ...
            <form
              ...
              className="w-full flex flex-col gap-5 bg-white p-6 sm:p-10 text-slate-800">
              {/* ชื่อ*/}
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded-lg bg-slate-50 text-slate-800 placeholder-slate-400 border border-slate-300 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent transition text-sm"
                />
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 max-sm:text-sm rounded-lg bg-slate-50 text-slate-800 placeholder-slate-400 border border-slate-300 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent transition"
                />
              </div>
              ...
              <div className="flex flex-col gap-2">
                <label className="text-slate-800 text-sm font-semibold">
                  สินค้าหรือบริการของคุณอยู่ในกลุ่มใด{" "}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 mt-1">
                  {product.map((item) => (
                    <label
                      key={item.key}
                      className="flex items-center gap-2.5 p-2.5 rounded-lg border border-slate-200 hover:bg-slate-50 cursor-pointer transition">
                      <input
                        type="radio"
                        name="product"
                        value={item.key}
              ...
              <div className="flex flex-col gap-2">
                <label className="text-slate-800 text-sm font-semibold">
                  ขนาดพื้นที่ที่สนใจ <span className="text-red-500">*</span>
                </label>
        ...
        <div className="w-full max-w-[1040px] flex justify-center mb-3">
          <img
            src={
              "https://worldfair.blob.core.windows.net/hms2026landing/exhibitor.png"
            }
            alt="exhibitor"
            className="w-full h-auto object-contain block"
          />
