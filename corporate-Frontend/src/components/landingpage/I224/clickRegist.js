...
export default function ClickRegist(props) {
  ...
  return (
    <div
      className={`flex justify-center gap-2 sm:gap-8 md:gap-2 rounded-full  text-white py-3 md:w-3/4 max-w-[800px] relative z-20 bg-gradient-to-r from-[#f17172] to-[#ef5658] hover:from-[#f6a7a3] hover:to-[#f17172]`}
    >
