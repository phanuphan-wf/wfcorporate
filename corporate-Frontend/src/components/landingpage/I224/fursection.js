...
export default function FurSection() {
  return (
    <section id="fur-section">
      ...
      */}
      <div className="xl:container w-full bg-[#f17172] flex items-center justify-evenly py-2 mb-4">
        ...
        <div>
          <div className="flex gap-0.5 items-center md:text-xl lg:text-2xl text-white">
            <MdLocationOn className="drop-shadow-md" />
            <span className="drop-shadow-md ">ฮอลล์ 9-10</span>
          </div>
          <div className="flex gap-0.5 items-center md:text-xl lg:text-2xl text-white">
