...
export default function FurSection() {
  return (
    <section id="fur-section">
      ...
      <div className="xl:container w-full bg-amber-300 flex items-center justify-evenly py-2 mb-4">
        ...
        <div>
          <div className="flex gap-0.5 items-center md:text-xl lg:text-2xl">
            ...
            <span className="drop-shadow-md">ฮอลล์ 1-3</span>
          </div>
          <div className="flex gap-0.5 items-center md:text-xl lg:text-2xl">
            <MdAvTimer className="drop-shadow-md" />
            <span className="drop-shadow-md">10.30-20.00 น.</span>
          </div>
        </div>
      </div>
    </section>
