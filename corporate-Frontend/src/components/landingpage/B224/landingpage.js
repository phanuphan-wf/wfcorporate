...
export default function Landingpage(props) {
  ...
  useEffect(() => {
    document.title = "Bangkok Furniture Fair Information";
  ...
  return (
    <section className={`landing_${exId}`}>
      ...
      <div className="flex gap-4 lg:gap-10 w-full justify-center mb-4">
        <div className="bg-black text-white px-4 py-1 text-sm md:text-2xl lg:text-3xl flex items-center gap-1 rounded-full">
          <MdLocationOn />
          ฮอลล์ EH 102-104
        </div>
        <div className="bg-black text-white px-4 py-1 text-sm md:text-2xl lg:text-3xl flex items-center gap-1 rounded-full">
      ...
      <div className="premium my-6">
        <img
          src={require("./img/sponsor_b224.png")}
          alt="premium bag"
          id="premium"
