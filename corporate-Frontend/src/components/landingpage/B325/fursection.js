...
export default function FurSection() {
  ...
  return (
    <section id="fur-section">
      ...
      <div className="xl:container bg-gradient-to-b from-[#0C6C37] to-[#0F8444] py-6">
...
*/}
      ...
      <div className="xl:container w-full bg-[#0F8444] flex items-center justify-evenly py-4 mb-4">
