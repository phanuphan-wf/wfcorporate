...
export default function FurSection() {
  ...
  return (
    <section id="fur-section">
      ...
      <div className="xl:container bg-gradient-to-r to-[#FFE42C] from-[#FFB230] py-6">
...
*/}
      ...
      <div className="xl:container w-full bg-[#2E3192] flex items-center justify-evenly py-4 mb-4">
