...
export default function Landingpage(props) {
  ...
  return (
    <section className={`landing_${exId}`}>
      ...
      <div
        className="text-center text-xl sm:text-2xl lg:text-4xl font-medium mb-8"
        style={{ marginTop: `${bannerH * 0.75}px` }}
      >
        HOME DECOR 2023{mobile ? <br /> : " | "}วันที่ 9-17 ธ.ค. 2566
      </div>
      <div
        ref={clickPos}
      ...
      >
        ...
        <div
          className={`flex justify-center gap-4 sm:gap-8 md:gap-2 bg-emerald-800 rounded-3xl md:rounded-xl text-white py-4 md:w-3/4 max-w-[800px] hover:bg-emerald-900 relative z-20`}
        >
      ...
      {fixedClick && (
        ...
        >
          {/*--------แก้ hidden เป็น flex เพื่อเปิด register----*/}
          <div
            className={`flex justify-center gap-4 sm:gap-8 md:gap-2 bg-emerald-800 rounded-3xl md:rounded-xl text-white py-4 md:w-3/4 max-w-[800px] hover:bg-emerald-900`}
          >
            <div className="text-3xl -rotate-45">
              <BsFillHandIndexThumbFill />
            </div>
      ...
      <div className="relative mx-5 lg:mx-0">
        ...
        <div className="w-fit mx-auto mt-7 md:mt-14 relative z-[900] mix-blend-multiply">
          <img
            ...
            alt="furniture logo"
            id="fur_logo"
            className="w-2/3 md:w-full mx-auto drop-shadow-[0_10px_10px_rgba(0,0,0,0.35)]"
          />
        </div>
      </div>
      ...
      >
        {/*--------แก้ hidden เป็น flex เพื่อเปิด register----*/}
        <div className="flex justify-center gap-4 sm:gap-8 md:gap-2 bg-emerald-800 rounded-3xl md:rounded-xl text-white py-4 md:w-3/4 max-w-[800px] hover:bg-emerald-900">
          <div className="text-3xl -rotate-45">
            <BsFillHandIndexThumbFill />
          </div>
          <div className="text-center md:text-start text-xl sm:text-2xl md:text-3xl">
