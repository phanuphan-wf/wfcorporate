...
export default function ClickRegist(props) {
  ...
  return (
    <div
      className={`flex justify-center gap-2 sm:gap-8 md:gap-2 rounded-full  text-white py-3 md:w-3/4 max-w-[800px] relative z-20 bg-gradient-to-r from-[#F04510] to-[#F47114] hover:from-orange-700 hover:to-orange-600`}
    >
