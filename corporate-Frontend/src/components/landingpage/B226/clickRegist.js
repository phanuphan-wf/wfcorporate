...
export default function ClickRegist(props) {
  ...
  return (
    <div
      className={`flex justify-center items-center gap-2 sm:gap-8 md:gap-2 rounded-full px-3 py-2 w-fit max-w-[800px] relative z-20 bg-gradient-to-t from-[#e99e35] to-[#f3d743] hover:from-yellow-600 hover:to-yellow-400 border-[3px] border-[#f4a61d]`}>
