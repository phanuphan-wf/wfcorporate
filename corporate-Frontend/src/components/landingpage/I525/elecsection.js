  ...
  return (
    <section id="elec-section">
      ...
      */}
      ...
      <div className="xl:container bg-gradient-to-br from-[#7F1728] from-[10%] via-[#EB2627] to-[#7F1728] to-[90%] py-6">
      ...
      <div className="xl:container w-full bg-[#4A1E6C] flex items-center justify-evenly py-4 mb-4">
