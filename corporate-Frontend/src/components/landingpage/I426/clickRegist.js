  ...
  return (
    <div
      className={`flex justify-center items-center gap-2 sm:gap-8 md:gap-2 rounded-full px-3 py-2 w-fit max-w-[800px]
                  relative z-20 bg-gradient-to-t from-[#f26e32] to-[#f26e32] 
                  hover:from-orange-600-600 hover:to-orange-400 
                  border-[3px] border-[#f26e32]                
      `}
    >

      <div className="text-3xl md:text-5xl lg:text-6xl bg-[#3dc1d3] rounded-full text-white flex justify-center items-center h-fit w-fit p-1">
        <IoIosArrowForward />
      </div>
