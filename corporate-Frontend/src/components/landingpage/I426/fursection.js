...
export default function FurSection() {
  ...
  return (
    <section id="fur-section">
      ...
      <div className="xl:container bg-gradient-to-b from-[#f26e32] to-[#f26e32] py-6">
...
*/}
      ...
      <div className="xl:container w-full bg-[#f26e32] flex items-center justify-evenly py-4 mb-4">
