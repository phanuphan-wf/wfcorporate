...
export default function Registration(props) {
  ...
  return (
    <section className="regist_b124 xl:container">
      <div className="w-full flex justify-center my-3">
        <img
          src={require("../../landingpage/B224/img/fur_logo.png")}
          alt="landing hero"
          id="hero_banner"
      ...
      <div className="text-center text-xl md:text-xl lg:text-3xl font-medium mb-4">
        <strong>FURNITURE</strong> LIVING & DESIGN 2024{mobile ? <br /> : " | "}
        วันที่ 25 พ.ค. - 2 มิ.ย. 2567
      </div>
      <div className="flex gap-4 lg:gap-10 w-full justify-center mb-4">
        <div className="bg-black text-white px-3 py-1 text-sm md:text-xl lg:text-2xl flex items-center gap-1 rounded-full">
          <MdLocationOn />
          ฮอลล์ EH 102-104
        </div>
        <div className="bg-black text-white px-3 py-1 text-sm md:text-xl lg:text-2xl flex items-center gap-1 rounded-full">
      ...
      <div className="container max-w-5xl px-10 mb-10">
        ...
        <div
          className="mt-3 mx-auto w-full sm:w-3/4 md:w-1/2 bg-gradient-to-r from-red-900 from-[50%] to-orange-500 bg-[size:200%] bg-[position:_0%_0%] hover:bg-[position:_100%_100%] text-white rounded-lg text-center py-1 transition-all duration-300 max-md:text-lg"
          onClick={submitData}
        >
          บันทึกข้อมูล
        </div>
