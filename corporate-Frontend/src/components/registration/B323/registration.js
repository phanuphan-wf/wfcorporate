...
export default function Registration(props) {
  ...
  return (
    <section className="regist_b323">
      <div className="w-full md:h-fit lg:h-[520px]">
        <img
          src={require("../../landingpage/B323/img/hero_banner.webp")}
          alt="landing hero"
          id="hero_banner"
      ...
      <div className="container max-w-5xl px-10 mb-10">
        ...
        <div
          className="mt-3 mx-auto w-full sm:w-3/4 md:w-1/2 bg-red-500 hover:bg-red-700 text-white rounded-lg text-center py-1"
          onClick={submitData}
        >
          บันทึกข้อมูล
        </div>
