  ...
  return (
    <section className="regist_b124 xl:container">
      <div className="w-full flex justify-center my-3">
        <img
          src={require("../../landingpage/B124/img/fur_logo.png")}
          alt="landing hero"
          id="hero_banner"
      ...
      <div className="text-center text-xl md:text-xl lg:text-3xl font-medium mb-4">
        Bangkok Furniture Fair 2024{mobile ? <br /> : " | "}วันที่ 9-17 มีนาคม
        2567
      </div>
      <div className="flex gap-4 lg:gap-10 w-full justify-center mb-4">
        <div className="bg-black text-white px-2 py-1 text-sm md:text-xl lg:text-2xl flex items-center gap-1 md:rounded-sm">
          <MdLocationOn />
          ฮอลล์ EH 103-104
        </div>
        <div className="bg-black text-white px-2 py-1 text-sm md:text-xl lg:text-2xl flex items-center gap-1 md:rounded-sm">
