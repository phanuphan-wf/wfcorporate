...
export default function Registration(props) {
  ...
  return (
    <section className="regist_i323 xl:container">
      <div className="w-full flex items-center flex-col">
        <img
          src={require("../../landingpage/I124/img/fur_logo_sm.png")}
          alt="landing hero"
          id="hero_banner"
          className="mx-auto w-2/3 md:w-1/2 lg:w-1/3"
        />
        <div className="py-4 bg-gradient-to-b from-indigo-900 from-[75%] to-blue-500 w-full text-white text-center">
          <div className="text-xl sm:text-2xl">13-21 มกราคม 2567</div>
          <div className="text-xl sm:text-2xl">อิมแพ็ค เมืองทองธานี</div>
        </div>
      </div>
      ...
      <div className="container max-w-5xl px-10 mb-10">
        ...
        <div
          className="mt-3 mx-auto w-full sm:w-3/4 md:w-1/2 bg-gradient-to-r from-indigo-900 from-[75%] to-blue-500 bg-[size:200%] bg-[position:_0%_0%] hover:bg-[position:_100%_100%] text-white rounded-lg text-center py-1 transition-all duration-300 max-md:text-lg"
          onClick={submitData}
        >
          บันทึกข้อมูล
        </div>
