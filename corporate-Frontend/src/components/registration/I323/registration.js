...
export default function Registration(props) {
  ...
  return (
    <section className="regist_i323">
      <div className="w-full flex items-center flex-col">
        <img
          src={require("../../landingpage/I323/img/fur_logo.png")}
          alt="landing hero"
          id="hero_banner"
          className="mx-auto lg:w-fit"
        />
        <div className="text-xl sm:text-2xl">2-10 กันยายน 2566</div>
      ...
      <div className="container max-w-5xl px-10 mb-10">
        ...
        <div
          className="mt-3 mx-auto w-full sm:w-3/4 md:w-1/2 bg-gradient-to-r from-blue-500 to-green-500 hover:from-blue-800 hover:to-green-800 text-white rounded-lg text-center py-1"
          onClick={submitData}
        >
          บันทึกข้อมูล
        </div>
