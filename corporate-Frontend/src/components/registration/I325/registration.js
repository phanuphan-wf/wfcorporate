...
export default function Registration(props) {
  ...
  const { t: t2 } = useTranslation("landing", { keyPrefix: "regist2" });
  ...
  return (
    <section className="regist_i325 xl:container">
      ...
      <div className="w-full flex justify-center my-3">
        <img
          src={require("../../landingpage/I325/img/fur_logo.png")}
          alt="landing hero"
          id="hero_banner"
      ...
      <div className="container max-w-5xl px-10 mb-10">
        ...
        <div
          className="mt-3 mx-auto w-full sm:w-3/4 md:w-1/2 bg-gradient-to-r from-orange-800 from-[50%] to-orange-500 bg-[size:200%] bg-[position:_0%_0%] hover:bg-[position:_100%_100%] text-white rounded-lg text-center py-1 transition-all duration-300 max-md:text-lg"
          onClick={submitData}
          disabled={submiting}>
