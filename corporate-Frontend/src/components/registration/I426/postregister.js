...
export default function Postregister(props) {
  const { t, i18n } = useTranslation("landing", { keyPrefix: "regist2.post" });
  ...
  return (
    <div className="lg:container">
      ...
      <div className="flex gap-4 lg:gap-10 w-full justify-center mb-4">
        <div className="bg-[#3dc1d3] text-white px-3 py-1 text-sm md:text-xl lg:text-2xl flex items-center gap-1 rounded-full">
          <MdLocationOn />
          {tr("hall")}
        </div>
        <div className="bg-[#3dc1d3] text-white px-3 py-1 text-sm md:text-xl lg:text-2xl flex items-center gap-1 rounded-full">
