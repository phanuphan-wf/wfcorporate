  ...
  return (
    <section className="regist_b124 xl:container">
      <div className="w-full flex justify-center my-3">
        <img
          src={require("../../landingpage/I224/img/fur_logo.png")}
          alt="landing hero"
          id="hero_banner"
      ...
      <div className="text-center text-xl md:text-xl lg:text-3xl font-medium mb-4">
        Furniture Fair Mid Year{mobile ? <br /> : " | "}
        วันที่ 8-16 มิ.ย. 2567
      </div>
      <div className="flex gap-4 lg:gap-10 w-full justify-center mb-4">
        <div className="bg-[#00987a] text-white px-4 py-1 text-sm md:text-2xl lg:text-3xl flex items-center gap-1 rounded-full">
          <MdLocationOn />
          ฮอลล์ 9-10
        </div>
        <div className="bg-[#00987a] text-white px-4 py-1 text-sm md:text-2xl lg:text-3xl flex items-center gap-1 rounded-full">
      ...
      <div className="container max-w-5xl px-10 mb-10">
        ...
        <div
          className="mt-3 mx-auto w-full sm:w-3/4 md:w-1/2 bg-gradient-to-r from-[#ef5658] from-[50%] to-[#994646] bg-[size:200%] bg-[position:_0%_0%] hover:bg-[position:_100%_100%] text-white rounded-lg text-center py-1 transition-all duration-300 max-md:text-lg"
          onClick={submitData}
        >
          บันทึกข้อมูล
        </div>
