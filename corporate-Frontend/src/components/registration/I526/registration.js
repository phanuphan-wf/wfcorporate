  ...
  return (
    <section className="regist_i526 xl:container">
      ...
      <div className="container max-w-5xl px-10 mb-10">
        ...
        <div
          className="mt-3 mx-auto w-full sm:w-3/4 md:w-1/2 bg-gradient-to-r from-[#fbd953] from-[50%] to-yellow-500/75 bg-[size:200%] bg-[position:_0%_0%] hover:bg-[position:_100%_100%] text-black rounded-lg text-center py-1 transition-all duration-300 max-md:text-lg"
          onClick={submitData}
          disabled={submiting}>
