...
export default function PicsvgReverse(props) {
  ...
  return (
    <div ref={ref} className="hidden md:block">
      <div className="absolute bottom-0 right-0 z-0 -scale-x-100">
        <svg
          width={width * 0.125}
          height="170"
      ...
      <div className="absolute bottom-0 right-0 z-[1] -scale-x-100">
        <svg
          width={width * 0.3}
          height="320"
      ...
      <div className="absolute bottom-0 right-0 z-[2] w-full -scale-x-100">
        <svg
          width={width}
          height="240"
